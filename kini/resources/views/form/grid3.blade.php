		...
		<div class="row text-center">
			...
			<div class="col-sm-1 text"><input type="text" value="{{$filas[0]->f1c4}}" class="ball read" name="valor" id="f1c4" > </div>
			<div class="col-sm-1 text"><input type="text" value="{{$filas[0]->f1c5}}" class="ball read" name="valor" id="f1c5" > </div>
			<div class="col-sm-1 text"><input type="text" value="{{$filas[0]->f1c6}}" class="ball read" name="valor" id="f1c6" > </div>
		</div>	
		<br>
		<div class="row text-center">
